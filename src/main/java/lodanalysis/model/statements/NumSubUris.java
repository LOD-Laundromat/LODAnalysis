...
public class NumSubUris extends CreateModelStatement {
	...
	public void createDescription() throws IOException {
		doc.addProperty(getProp(Namespace.VOID_EXT, "distinctIRIReferenceSubjects"), FileUtils.readFileToString(new File(dir, Paths.DISTINCT_URIS_SUB)), XSDDatatype.XSDinteger);
	}
