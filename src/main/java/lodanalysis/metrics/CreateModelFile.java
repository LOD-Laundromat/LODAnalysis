...
public class CreateModelFile {
	...
	private static final String NS_LL = "http://lodlaundromat.org/resource/";
	private static final String NS_LLO = "http://lodlaundromat.org/ontology/";
	private static final String NS_VOID = "http://rdfs.org/ns/void#";
	...
	private static final String NS_DS = "http://bio2rdf.org/bio2rdf.dataset_vocabulary:";
	...
	public CreateModelFile(File metricDir) throws IOException {
		/**
		 * Set Namespaces
		 */
		 ...
		 * Make links
		 */
		doc = model.createResource(NS_LL + metricDir.getName());
		voidDoc = model.createResource(NS_LL + metricDir.getName() + "/metrics");
		...
		String tripleCount = FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_TRIPLE_COUNT));
		...
		voidDoc.addProperty(voidClasses, Integer.toString(countLines(new File(metricDir, Settings.FILE_NAME_TYPE_COUNTS))), XSDDatatype.XSDlong);
		
		String distinctPredicates = Integer.toString(countLines(new File(metricDir, Settings.FILE_NAME_PREDICATE_COUNTS)));
		...
		String distinctObjects = FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_OBJECT_COUNT));
		...
		String distinctSubjects = FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_SUBJECT_COUNT));
		...
		String distinctEntities = FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_URI_COUNT));
		...
		addBio2RdfSubsetProp(model.createResource(NS_DS + "Dataset-Distinct-Literals"), FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_LITERAL_COUNT)));
		...
		inDegreeBnode.addProperty(llMean, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_INDEGREE_AVG)), XSDDatatype.XSDdouble);
		inDegreeBnode.addProperty(llMedian, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_INDEGREE_MEDIAN)), XSDDatatype.XSDlong);
		inDegreeBnode.addProperty(llRange, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_INDEGREE_RANGE)), XSDDatatype.XSDlong);
		inDegreeBnode.addProperty(llStd, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_INDEGREE_STD)), XSDDatatype.XSDdouble);
		voidDoc.addProperty(llInDegree, inDegreeBnode);
		Resource outDegreeBnode = model.createResource();
		outDegreeBnode.addProperty(llMean, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_OUTDEGREE_AVG)), XSDDatatype.XSDdouble);
		outDegreeBnode.addProperty(llMedian, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_OUTDEGREE_MEDIAN)), XSDDatatype.XSDlong);
		outDegreeBnode.addProperty(llRange, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_OUTDEGREE_RANGE)), XSDDatatype.XSDlong);
		outDegreeBnode.addProperty(llStd, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_OUTDEGREE_STD)), XSDDatatype.XSDdouble);
		voidDoc.addProperty(llOutDegree, outDegreeBnode);
		Resource degreeBnode = model.createResource();
		degreeBnode.addProperty(llMean, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_DEGREE_AVG)), XSDDatatype.XSDdouble);
		degreeBnode.addProperty(llMedian, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_DEGREE_MEDIAN)), XSDDatatype.XSDlong);
		degreeBnode.addProperty(llRange, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_DEGREE_RANGE)), XSDDatatype.XSDlong);
		degreeBnode.addProperty(llStd, FileUtils.readFileToString(new File(metricDir, Settings.FILE_NAME_DEGREE_STD)), XSDDatatype.XSDdouble);
		 ...
		 */
		for (String propLine: FileUtils.readLines(new File(metricDir, Settings.FILE_NAME_PREDICATE_COUNTS))) {
		 ...
		 */
		for (String classLine: FileUtils.readLines(new File(metricDir, Settings.FILE_NAME_TYPE_COUNTS))) {
		...
		for (String typeLine: FileUtils.readLines(new File(metricDir, Settings.FILE_NAME_TYPE_COUNTS))) {
		...
		for (String predLine: FileUtils.readLines(new File(metricDir, Settings.FILE_NAME_PREDICATE_NON_LIT_COUNTS))) {
		...
		for (String predLine: FileUtils.readLines(new File(metricDir, Settings.FILE_NAME_PREDICATE_LITERAL_COUNTS))) {
			String[] predLineSplit = predLine.split("\\t");
			if (predLineSplit.length != 3) throw new IllegalStateException("Unexpected input. Cannot split: " + predLine);
...
//		model.write(System.out, "TTL");
		model.write(new FileOutputStream(new File(metricDir, Settings.FILE_NAME_DESCRIPTION_TTL)), "TTL");
	}
